        ...
        <>
            ...
            <Container maxW='container.2xl' p={4}>
                <Flex justify='space-between' alignItems='center'>
                    <Heading color='#2E4660' size='lg'>List Storages</Heading>
                    <Button bg='#496F97' size='sm' color='white' _hover={{ bg: '#2E4660' }} as='a' href='/add-storage'>Add Storage</Button>
                </Flex>
                <TableContainer mt={8}>
                        ...
                        <Tbody>
                            {dataUse.map((item, index) => (
                                <Tr key={index}>
                                    ...
                                    <Td>
                                        <Flex gap={2}>
                                            <Button bg='green.300' size='sm' color='white' _hover={{ bg: 'green.600' }} as='a' href={`storage/${item.storageId}?storagetype=${item.storageType}&storagename=${item.storageName}&path=/`}>Open</Button>
                                            <Button bg='red.300' size='sm' color='white' _hover={{ bg: 'red.600' }} onClick={(e) => handleDelete(item.id)}>Delete</Button>
                                        </Flex>
                                    </Td>
                                </Tr>
                            ))}
